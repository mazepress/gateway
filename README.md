# MazePress - Gateway
A package library for managing online payments.
...
3. Run `Composer install mazepress/gateway`
...
```json
{
  ...
  "repositories": [
    {
      "type": "vcs",
      "url": "https://github.com/mazepress/gateway.git"
    }
  ],
  "require": {
    "mazepress/gateway": "dev-main"
  },
  "extra": {
    "installer-paths": {
      "packages/{$name}": [
